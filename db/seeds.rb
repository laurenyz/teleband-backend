...
assignment1 = Assignment.create(title: "Assignment 1", instructions: "Play this", assignment_type:"audio", notation_url:"http://africau.edu/images/default/sample.pdf")
assignment2 = Assignment.create(title: "Assignment 2", instructions: "Play this", assignment_type:"audio", notation_url:"http://africau.edu/images/default/sample.pdf")
assignment3 = Assignment.create(title: "Assignment 3", instructions: "Play this", assignment_type:"audio", notation_url:"http://africau.edu/images/default/sample.pdf")
assignment4 = Assignment.create(title: "Assignment 4", instructions: "Play this", assignment_type:"audio", notation_url:"http://africau.edu/images/default/sample.pdf")
assignment5 = Assignment.create(title: "Assignment 5", instructions: "Play this", assignment_type:"audio", notation_url:"http://africau.edu/images/default/sample.pdf")
assignment6 = Assignment.create(title: "Assignment 6", instructions: "Play this", assignment_type:"audio", notation_url:"http://africau.edu/images/default/sample.pdf")
assignment7 = Assignment.create(title: "Assignment 7", instructions: "Play this", assignment_type:"audio", notation_url:"http://africau.edu/images/default/sample.pdf")
