...
StudentAssignment.create(student: matteo, assignment: assignment7, student_audio:"", tone: nil, expression: nil, rhythm: nil)
StudentAssignment.create(student: wesley, assignment: assignment1, student_audio:"", tone: nil, expression: nil, rhythm: nil)
...
StudentAssignment.create(student: tyrion, assignment: assignment1, student_audio:"", tone: nil, expression: nil, rhythm: nil)
StudentAssignment.create(student: tyrion, assignment: assignment2, student_audio:"", tone: nil, expression: nil, rhythm: nil)
StudentAssignment.create(student: tyrion, assignment: assignment3, student_audio:"", tone: nil, expression: nil, rhythm: nil)
StudentAssignment.create(student: tyrion, assignment: assignment4, student_audio:"", tone: nil, expression: nil, rhythm: nil)
